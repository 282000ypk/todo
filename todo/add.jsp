...
try
{
	out.print("insert into task values(DEFAULT,'"+name+"','"+cid+"',NOW(),NOW(),"+sdate+","+stime+","+edate+","+etime+")");
    ...
    try{
    rs=st.executeQuery("insert into task values(DEFAULT,'"+name+"','"+cid+"',NOW(),NOW(),"+sdate+","+stime+","+edate+","+etime+")");}
    catch(Exception ee)
    {
    	out.print(ee);
    }
